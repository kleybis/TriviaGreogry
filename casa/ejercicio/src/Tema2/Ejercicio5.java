...
public class Ejercicio5 {
	...
	public static void main(String[] args) {
		...
		/**
		 * 5. Programa que calcule el sueldo líquido a percibir por un vendedor sabiendo que
el sueldo total incluye los siguientes conceptos:
- Sueldo fijo.
...
o La retención de la Seguridad social (150 euros).
- Al sueldo fijo se le debe descontar:
o La retención del IRPF: 18%.
